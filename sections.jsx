      ...
      <div className="hero-inner">
        ...
        <div className="hero-grid">
          <div>
            ...
            <a href="tel:0537820331" className="hero-call" aria-label="면접 상담 전화" style={{ textDecoration: 'none' }}>
...
{ lab: 'STEP 02', t: '예상 질문 추출', d: '학생부와 지원 학과 정보를 바탕으로 마이더스K가 예상 질문지를 작성합니다.' },
{ lab: 'STEP 03', t: '면접 컨설팅 진행', d: '1:2 컨설팅으로 답변 보강 · 위기 대응 시뮬레이션 · 태도·자세·발성 코칭을 진행합니다.' }];
  ...
  return (
    <section>
      <Reveal>
        ...
        <p className="sub">상담 신청 및 비용 입금 → 예상 질문 추출 → 면접 컨설팅 진행</p>
      </Reveal>
...
{ lab: '온라인 신청', v: '통합 신청폼 작성하기', d: '신청폼이 대입 수시 면접컨설팅에 체크된 채로 열립니다.', href: 'https://midasksegu-afk.github.io/brochure/midasK-form.html#c03', cta: '신청폼 열기 ↗' }];
...
function FloatCTA() {
  return (
    <div className="float-cta" aria-label="quick contact">
      <a href="https://midasksegu-afk.github.io/brochure/midasK-form.html#c03" target="_blank" rel="noopener">
